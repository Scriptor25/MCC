...
namespace mcc
{
    ...
    void Assert(bool condition, const SourceLocation &where, const char *message);
    void Assert(bool condition, const SourceLocation &where, const std::string &message);
    ...
    template<typename... Args>
    void Assert(const bool condition, const SourceLocation &where, const char *format, Args &&... args)
    {
        Assert(condition, where, std::vformat(format, std::make_format_args(args...)));
    }

    template<typename... Args>
    void Assert(const bool condition, const SourceLocation &where, const std::string_view &format, Args &&... args)
    {
        Assert(condition, where, std::vformat(format, std::make_format_args(args...)));
    }
}

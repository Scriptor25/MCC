...
mcc::FunctionPtr mcc::Builder::CreateFunction(const SourceLocation &where, ResourceLocation location, const ParameterList &parameters, const TypePtr &result, const bool throws)
{
    if (location.Namespace.empty())
        location.Namespace = m_Namespace;
...
mcc::ValuePtr mcc::Builder::CreateVariable(const SourceLocation &where, const TypePtr &type, const std::string &name, const bool is_constant, const ValuePtr &initializer)
{
...
mcc::InstructionPtr mcc::Builder::CreateStore(const SourceLocation &where, const ValuePtr &dst, const ValuePtr &src, const bool force) const
{
...
mcc::InstructionPtr mcc::Builder::CreateComparison(const SourceLocation &where, const ComparatorE comparator, const ValuePtr &left, const ValuePtr &right) const
{
    Assert(!!m_InsertBlock, where, "insert block must not be null");
    ...
    return Insert(where, ComparisonInstruction::Create(where, m_Context, comparator, m_InsertBlock->Parent->Location, left, right));
}

mcc::InstructionPtr mcc::Builder::CreateOperation(const SourceLocation &where, const OperatorE operator_, const std::vector<ValuePtr> &operands) const
{
    Assert(!!m_InsertBlock, where, "insert block must not be null");
    ...
    return Insert(where, OperationInstruction::Create(where, m_Context, operator_, m_InsertBlock->Parent->Location, operands));
}

mcc::InstructionPtr mcc::Builder::CreateCommand(const SourceLocation &where, const TypePtr &type, const CommandT &command) const
{
    Assert(!!m_InsertBlock, where, "insert block must not be null");
...
mcc::InstructionPtr mcc::Builder::CreateBranch(const SourceLocation &where, const ValuePtr &condition, const BlockPtr &then_target, const BlockPtr &else_target) const
{
    Assert(!!m_InsertBlock, where, "insert block must not be null");
    ...
    return Insert(where, BranchInstruction::Create(where, m_Context, m_InsertBlock->Parent->Location, condition, then_target, else_target));
}
...
mcc::InstructionPtr mcc::Builder::CreateDirect(const SourceLocation &where, const BlockPtr &target, const ValuePtr &result, const ValuePtr &branch_result) const
{
    Assert(!!m_InsertBlock, where, "insert block must not be null");
    Assert(!!target, where, "target must not be null");
    ...
    return Insert(where, DirectBranchInstruction::Create(where, m_Context, m_InsertBlock->Parent->Location, target, result, branch_result));
}

mcc::InstructionPtr mcc::Builder::CreateSwitch(const SourceLocation &where, const ValuePtr &condition, const BlockPtr &default_target, const std::vector<std::pair<ConstantPtr, BlockPtr>> &case_targets) const
{
    Assert(!!m_InsertBlock, where, "insert block must not be null");
    Assert(!!condition, where, "condition must not be null");
    ...
    return Insert(where, SwitchInstruction::Create(where, m_Context, m_InsertBlock->Parent->Location, condition, default_target, case_targets));
}

mcc::InstructionPtr mcc::Builder::CreateThrow(const SourceLocation &where, const ValuePtr &value, const BlockPtr &landing_pad) const
{
    Assert(!!m_InsertBlock, where, "insert block must not be null");
    Assert(!!value, where, "value must not be null");

    return Insert(where, ThrowInstruction::Create(where, m_Context, m_InsertBlock->Parent->Location, value, landing_pad));
}
...
mcc::InstructionPtr mcc::Builder::CreateCall(const SourceLocation &where, const FunctionPtr &callee, const std::vector<ValuePtr> &arguments, const BlockPtr &landing_pad) const
{
    Assert(!!m_InsertBlock, where, "insert block must not be null");
    ...
    return Insert(where, CallInstruction::Create(where, m_InsertBlock->Parent->Location, callee, argument_pairs, landing_pad));
}

mcc::InstructionPtr mcc::Builder::CreateMacro(const SourceLocation &where, const std::string &name, const std::vector<ValuePtr> &arguments) const
{
    Assert(!!m_InsertBlock, where, "insert block must not be null");
...
mcc::InstructionPtr mcc::Builder::CreateAllocation(const SourceLocation &where, const TypePtr &type, const bool is_constant, const ConstantPtr &initializer) const
{
    Assert(!!m_InsertBlock, where, "insert block must not be null");
...
mcc::InstructionPtr mcc::Builder::CreateAppend(const SourceLocation &where, const ValuePtr &array, const ValuePtr &value) const
{
    Assert(!!array, where, "array must not be null");
    Assert(!!value, where, "value must not be null");
    Assert(array->IsMutable, where, "array must be mutable");

    return Insert(where, ArrayInstruction::CreateAppend(where, m_Context, m_InsertBlock->Parent->Location, array, value));
}

mcc::InstructionPtr mcc::Builder::CreatePrepend(const SourceLocation &where, const ValuePtr &array, const ValuePtr &value) const
{
    Assert(!!array, where, "array must not be null");
    Assert(!!value, where, "value must not be null");
    Assert(array->IsMutable, where, "array must be mutable");

    return Insert(where, ArrayInstruction::CreatePrepend(where, m_Context, m_InsertBlock->Parent->Location, array, value));
}

mcc::InstructionPtr mcc::Builder::CreateInsert(const ValuePtr &array, const SourceLocation &where, const ValuePtr &value, const IndexT index) const
{
    Assert(!!array, where, "array must not be null");
    Assert(!!value, where, "value must not be null");
    Assert(array->IsMutable, where, "array must be mutable");

    return Insert(where, ArrayInstruction::CreateInsert(where, m_Context, m_InsertBlock->Parent->Location, array, value, index));
}

mcc::InstructionPtr mcc::Builder::CreateInsert(const SourceLocation &where, const ValuePtr &object, const ValuePtr &value, const std::string &key) const
{
    ...
    return Insert(where, ObjectInstruction::CreateInsert(where, m_Context, m_InsertBlock->Parent->Location, object, value, key));
}

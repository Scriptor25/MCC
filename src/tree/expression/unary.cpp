...
using UnaryOperation = std::function<
        mcc::ValuePtr(const mcc::SourceLocation &where, const mcc::Builder &builder, const mcc::ValuePtr &operand)
>;
